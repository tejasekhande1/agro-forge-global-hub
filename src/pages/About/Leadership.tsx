...
const Leadership = () => {
    const advisors = [
        {
            ...
            title: 'Chairman & MD- Enjo-Chem Group.',
            role: 'Advisory Leadership',
            description:
        ...
        },
        {
            ...
            role: 'Director',
            description:
                'Aniket holds a B.Tech in Chemical Engineering from VIT Pune. With a passion for global commerce and sustainable trade practices, he leads operational excellence and strategic planning at Enjo-Sak Global. His scientific acumen and problem-solving mindset play a key role in ensuring quality, compliance, and customer satisfaction across all our international trade verticals.\n' +
    ...
    // Group advisors by role
    const groupedAdvisors = advisors.reduce((acc, advisor) => {
        if (!acc[advisor.role]) acc[advisor.role] = [];
        acc[advisor.role].push(advisor);
        return acc;
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="py-16 bg-white">
                <div className="max-w-5xl mx-auto space-y-16">
                    {Object.entries(groupedAdvisors).map(([role, members]) => (
                                    ...
                                    >
                                        ...
                                        <div className="p-6">
                                            ...
                                            <CardContent className="p-0 pt-4">
                                                <p className="text-muted-foreground leading-relaxed text-sm md:text-base text-justify whitespace-pre-line">
                                                    {advisor.description}
                                                </p>
                                            </CardContent>
                                        </div>
